...
function ImportarGrafos(){
  ...
  const columnsComp = [
    ...
    {dataField: '', text: '', filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return <div>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChange(e, row, "fila")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChange(e,row, "fila")}/> : ''}</div>;},},
    {dataField: 'item3', text: <Translation ns= "global">{(t) => <>{t('accion')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return <div>{row.item2 === false ? `${EvaluarAccion(row.item3)}` : row.item3 !== 0 ? `${EvaluarAccion(row.item3)}` : ''}</div>;},},
    {dataField: 'item1.origen', text: <Translation ns= "global">{(t) => <>{t('origen')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true }, 
    {dataField: 'item1.codCarretera', text: <Translation ns= "global">{(t) => <>{t('CodCarr')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true }, 
    {dataField: 'item1.pkIni', text: <Translation ns= "global">{(t) => <>{t('PKInicial')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item4 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "pkIni")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "pkIni")}/> : ''} {row.item1.pkIni + '+' + row.item1.mIni}</div> : <div>{row.item1.pkIni + '+' + row.item1.mIni}</div> ;},},  
    {dataField: 'item1.pkFin', text: <Translation ns= "global">{(t) => <>{t('PKFinal')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item5 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "pkFin")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "pkFin")}/> : ''} {row.item1.pkFin + '+' + row.item1.mFin}</div> : <div>{row.item1.pkFin + '+' + row.item1.mFin}</div> ;},},  
    {dataField: 'item1.desIni', text: <Translation ns= "global">{(t) => <>{t('DescIni')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item6 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "desIni")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "desIni")}/> : ''} {row.item1.desIni}</div> : <div>{row.item1.desIni}</div> ;},},  
    {dataField: 'item1.desFin', text: <Translation ns= "global">{(t) => <>{t('DescFin')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true.valueOf, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item7 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "desFin")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "desFin")}/> : ''} {row.item1.desFin}</div> : <div>{row.item1.desFin}</div> ;},},  
    {dataField: 'item1.tecReal', text: <Translation ns= "global">{(t) => <>{t('ClasTecReal')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item8 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox"  id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "tecReal")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "tecReal")}/> : ''} {row.item1.tecReal}</div> : <div>{row.item1.tecReal}</div> ;},},  
    {dataField: 'item1.funReal', text: <Translation ns= "global">{(t) => <>{t('ClasFunRedes')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item9 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "funReal")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "funReal")}/> : ''} {row.item1.funReal}</div> : <div>{row.item1.funReal}</div> ;},},  
    {dataField: 'item1.competente', text: <Translation ns= "global">{(t) => <>{t('OrgCom')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item10 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "competente")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "competente")}/> : ''} {row.item1.competente}</div> : <div>{row.item1.competente}</div> ;},},  
    {dataField: 'item1.conservacion', text: <Translation ns= "global">{(t) => <>{t('OrgCons')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item11 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "conservacion")}/> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "conservacion")}/> : ''} {row.item1.conservacion}</div> : <div>{row.item1.conservacion}</div> ;},},  
    {dataField: 'item1.explotacion', text: <Translation ns= "global">{(t) => <>{t('RegExpl')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item12 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "explotacion")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "explotacion")}/> : ''} {row.item1.explotacion}</div> : <div>{row.item1.explotacion}</div> ;},},  
    {dataField: 'item1.gestion', text: <Translation ns= "global">{(t) => <>{t('RegGest')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true,formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item13 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "gestion")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "gestion")}/> : ''} {row.item1.gestion}</div> : <div>{row.item1.gestion}</div> ;},},  
    {dataField: 'item1.tipoCalzada', text: <Translation ns= "global">{(t) => <>{t('TipoCalzada')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item14 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "tipoCalzada")} /> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "tipoCalzada")}/> : ''} {row.item1.tipoCalzada}</div> : <div>{row.item1.tipoCalzada}</div> ;},},  
    {dataField: 'item1.numCarrCre', text: <Translation ns= "global">{(t) => <>{t('NumCarrilsCrec')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item15 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "numCarrCre")}/> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "numCarrCre")}/> : ''} {row.item1.numCarrCre}</div> : <div>{row.item1.numCarrCre}</div> ;},},
    {dataField: 'item1.numCarrDec', text: <Translation ns= "global">{(t) => <>{t('NumCarrilsDeCrec')}</>}</Translation>, filter: textFilter({placeholder: ' '}), sort: true, formatter: (cell, row) =>{return  row.item3 === 0 ? <div style={{width: '100%', backgroundColor:row.item16 === false ?'#FD0303':'#17b201'}}>{row.item2 === false ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e, row, "numCarrDec")}/> : row.item3 !== 0 ? <input type="checkbox" id={`custom-checkbox-${row.id}`} name={row.item1.idGraf} checked={checkedState[row.id]} onChange={(e) => handleOnChngField(e,row, "numCarrDec")}/> : ''} {row.item1.numCarrDec}</div> : <div>{row.item1.numCarrDec}</div> ;},}
 ]
